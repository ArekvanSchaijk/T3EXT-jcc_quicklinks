...
#
CREATE TABLE pages (
	tx_jccquicklinks_title varchar(255) DEFAULT '' NOT NULL,
	tx_jccquicklinks_links int(11) unsigned DEFAULT '0' NOT NULL,
);
...
CREATE TABLE tx_jccquicklinks_domain_model_link (
	...
	is_product tinyint(1) unsigned DEFAULT '0' NOT NULL,
